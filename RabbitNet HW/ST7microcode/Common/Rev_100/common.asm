...
;****************************************************************************************
 ...
 TITLE	"COMMON.ASM"
 MOTOROLA
 #INCLUDE "I:\Projects\Rabbitnet_Common\Microcode\Rev_100\st72264.inc"	
 #INCLUDE "I:\Projects\Rabbitnet_Common\Microcode\Rev_100\common.inc"	
...
.soft_reset:	ld	a,cmd07_stat		; Entry here preserves cmd07 status bits 5 & 6 
		and	a,#$40			;  (SRES) which indicates soft reset occurred
