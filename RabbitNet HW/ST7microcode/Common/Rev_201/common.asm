...
;****************************************************************************************
 ...
 TITLE	"COMMON.ASM"
 MOTOROLA
 #INCLUDE "I:\Projects\Rabbitnet_Common\Microcode\Rev_201\st72264.inc"	
 #INCLUDE "I:\Projects\Rabbitnet_Common\Microcode\Rev_201\common.inc"	
 ...
 WORDS  
 	...
 	EXTERN	unused1_jp   	;FFE0-FFE1h Unimplemented Interrupt 
	EXTERN	unused2_jp     	;FFE2-FFE3h Unimplemented Interrupt
	EXTERN	i2c_jp		;FFE4-FFE5h I2C Interrupt  
	EXTERN	sci_jp        	;FFE6-FFE7h Serial Comm Interrupt  
	EXTERN	unused3_jp    	;FFE8-FFE9h Unimplemented Interrupt  
	EXTERN	unused4_jp    	;FFEA-FFEBh Unimplemented Interrupt  
	EXTERN	avd_jp         	;FFEC-FFEDh Aux Voltage Detector Interrupt               
	EXTERN	timb_jp		;FFEE-FFEFh Timer B Interrupt
	EXTERN	mcc_jp		;FFF0-FFF1h Master Clock Control Interrupt                 
	EXTERN	tima_jp		;FFF2-FFF3h Timer A Interrupt                       
	EXTERN	spi_jp		;FFF4-FFF5h SPI Interrupt   
	EXTERN	css_jp      	;FFF6-FFF7h Clock Security System Interrupt             
	EXTERN	ext1_jp		;FFF8-FFF9h Port B External Interrupt 
	EXTERN	ext0_jp		;FFFA-FFFBh Port A External Interrupt                      
	EXTERN	trap_jp       	;FFFC-FFFDh interrupt vector location                       
	EXTERN	reset_jp	;FFFE-FFFFh interrupt vector location  
...
.c1r00:		ld	a,{sig_regs + 0}	; Get SS2CMD parameter
...
;********************************************************************************
		                                ; SPI NEW COMMAND
spi_nc:		ld	a,rn_stat		; Clear all the
...
spi_rt_20:	btjf	SPIDR,#7,spi_rt_30	; Check for Slave Command
		jp	router			; Router Cmd so process it		
spi_rt_30:	jp	spi_nc			; Go process slave command
